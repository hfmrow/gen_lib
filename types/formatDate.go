...
import (
	...
	gcc "github.com/hfmrow/gen_lib/strings/cClass"
)
...
func FindDate(inputString, fmtDate string) []string {
	...
	dateLongFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(outLong, "/"), false, false))
	dateShrtFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(outShort, "/"), false, false))
	dateSingleLongFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(outSingleLong, "/"), false, false))
	dateSingleShrtFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(outSingleShort, "/"), false, false))
	date1Single2LongFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(out1Single2Long, "/"), false, false))
	date1Single2ShrtFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(out1Single2Short, "/"), false, false))
	date2Single1LongFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(out2Single1Long, "/"), false, false))
	date2Single1ShrtFmt := regexp.MustCompile(gcc.StringToCharacterClasses(strings.Join(out2Single1Short, "/"), false, false))
