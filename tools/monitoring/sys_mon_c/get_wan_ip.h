...
#ifndef FUNCTIONS_GET_WAN_INCLUDED
#define FUNCTIONS_GET_WAN_INCLUDED
...
// same as above but returning 'wan adress'.
// Returned data must be freed.
char *return_wan_ip(char *stun_server_colon_port, short local_port);

typedef struct http_get_memory_struct {
  char *memory;
  size_t size;
} http_get_memory_struct;
...
/* STUN srv sites list: http://olegh.ftp.sh/public-stun.txt
#
# 623 public STUN-servers. Tested 2019-11-03
#
# Author: Oleg Khovayko (olegarch)
# Distributes under the Creative Common License:
# https://en.wikipedia.org/wiki/Creative_Commons_license */
static char *stun_list[] = {
